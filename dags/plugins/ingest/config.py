...
if EMPIRE_CONNECTION_URL is None or EMPIRE_CONNECTION_URL == "":
    print("Setting EMPIRE_CONNECTION_URL from hardcoded values. For production use, please set the EMPIRE_CONNECTION_URL environment variable instead of hardcoding credentials.")
...
if POSTGRESQL_CONNECTION_URL is None or POSTGRESQL_CONNECTION_URL == "":
    print("Setting POSTGRESQL_CONNECTION_URL from hardcoded values. For production use, please set the POSTGRESQL_CONNECTION_URL environment variable instead of hardcoding credentials.")
